...
public class P3Move : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 colBoxVector = new Vector3(2f, 2.90f, 0.2f);
        Collider[] hitColliders = Physics.OverlapBox(transform.position + new Vector3(0f, 0.3f, 0f), colBoxVector, transform.rotation);
